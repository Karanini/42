limits_500_tests_only() {
	local TEST_NAME="Limits tests (size 500)"
	test_box "Limits tests 500"
	...
	for i in {1..50}; do
		SEQUENCES=()
		generate_sequences 10 1 500 "$myseed"
